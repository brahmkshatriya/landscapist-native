...
/**
 * Desktop Native fallback implementation of [ImageRegionDecoder].
 *
 * Efficient region decoding is not currently available on desktop Native targets. Returning
 * `null` from the factory functions disables sub-sampling and falls back to normal image loading.
 */
